...
//}
    ...
    void Install_PlayerCustomData() {
        ...
        mem_seek(
            version_D2Client == V114d ? offset_D2Common + 0x221FDD : version_D2Client == V113d ? offset_D2Common + 0x170DE : version_D2Client == V113c ? offset_D2Common + 0x309BE : version_D2Client == V112 ? offset_D2Common + 0x585EE :
                                                                                                                                                                                     version_D2Client == V111b ? offset_D2Common + 0x5BFCE :
                                                                                                                                                                                     version_D2Common == V111 ? offset_D2Common + 0x4ED5E :
                                                                                                                                                                                     (DWORD) D2InitPlayerData + 0x62);
        ...
        if (version_D2Game >= V111 && version_D2Game <= V113d) {
            ...
            mem_seek(
                offset_D2Game + (
                    version_D2Game == V114d ? 0x0000 : (
                        version_D2Game == V113d ? 0x75C81 : (
                            version_D2Game == V113c ? 0x9BB91 : (
                                version_D2Game == V112 ? 0x5F2A1 : (
                                    version_D2Game == V111b ? 0xC3C51 : (
                                        version_D2Game == V111 ? 0x8BC71 : (version_D2Game == V110 ? 0x1100D : (version_D2Game == V109d ? 0x10C03 : 0x10933)))))))));
            ...
            mem_seek(
                offset_D2Game + (
                    version_D2Game == V114d ? 0x0000 : (
                        version_D2Game == V113d ? 0x75CE1 : (
                            version_D2Game == V113c ? 0x9BBF1 : (
                                version_D2Game == V112 ? 0x5F301 : (
                                    version_D2Game == V111b ? 0xC3CB1 : (
                                        version_D2Game == V111 ? 0x8BCD1 : (version_D2Game == V110 ? 0x11058 : (version_D2Game == V109d ? 0x10C4B : 0x1097B)))))))));
            memt_byte(0x8B, 0xE8); // CALL
        ...
        mem_seek(
            offset_D2Game + (
                version_D2Game == V114d ? 0x139A20 : (
                    version_D2Game == V113d ? 0xE7548 : (
                        version_D2Game == V113c ? 0x4BF12 : (
                            version_D2Game == V112 ? 0xED502 : (
                                version_D2Game == V111b ? 0xC6A32 : (
                                    version_D2Game == V111 ? 0x53482 : (version_D2Game == V110 ? 0x25D4 : (version_D2Game == V109d ? 0x2426 : 0x23EB)))))))));//6FC325D4-6FC30000
        ...
        mem_seek(
            offset_D2Common + (
                version_D2Common == V114d ? 0x2220DD : (
                    version_D2Common == V113d ? 0x1705D : (
                        version_D2Common == V113c ? 0x3093D : (
                            version_D2Common == V112 ? 0x5856D : (
                                version_D2Common == V111b ? 0x5C9CD : (
                                    version_D2Common == V111 ? 0x4F82D : (version_D2Common == V110 ? 0x80483 : (version_D2Common == V109d ? 0x7065C : 0x7055C)))))))));
        ...
        mem_seek(
            offset_D2Game + (
                version_D2Game == V114d ? 0x155B34 : (
                    version_D2Game == V113d ? 0x6F7C2 : (
                        version_D2Game == V113c ? 0xE1162 : (
                            version_D2Game == V112 ? 0x94242 : (
                                version_D2Game == V111b ? 0xBFDB2 : (
                                    version_D2Game == V111 ? 0x99112 : (version_D2Game == V110 ? 0x8D5A4 : (version_D2Game == V109d ? 0x7D62B : 0x7D12B)))))))));
        MEMJ_REF4(D2UnitGetNextItem, version_D2Game >= V114a ? callerServer_getNextItemToFree_114 : version_D2Game >= V111 ? callerServer_getNextItemToFree_111 : version_D2Game == V110 ? callerServer_getNextItemToFree
        ...
        mem_seek(
            offset_D2Client + (
                version_D2Client == V114d ? 0x66D02 : (
                    version_D2Client == V113d ? 0x621E4 : (
                        version_D2Client == V113c ? 0xA5C94 : (
                            version_D2Client == V112 ? 0x1F2D4 : (
                                version_D2Client == V111b ? 0x4C264 : (
                                    version_D2Client == V111 ? 0x26404 : (version_D2Client == V110 ? 0x89B32 : (version_D2Client == V109d ? 0x8E30F : 0x8EF8F)))))))));//6FB29B31-6FAA0000
        MEMJ_REF4(D2UnitGetNextItem, version_D2Game >= V114d ? callerClient_getNextItemToFree_114 : version_D2Game >= V111 ? callerClient_getNextItemToFree_111 : version_D2Game == V110 ? callerClient_getNextItemToFree
                                                                                                                                                                                         : callerClient_getNextItemToFree_9);//0x00040F34
        ...
        if (version_D2Common >= V110) {
            ...
            mem_seek(
                offset_D2Common + (
                    version_D2Common == V114d ? 0x23ADB5 : (
                        version_D2Common == V113d ? 0x3B393 : (
                            version_D2Common == V113c ? 0x21B23 : (
                                version_D2Common == V112 ? 0x6AE93 : (
                                    version_D2Common == V111b ? 0x42133 : (
                                        version_D2Common == V111 ? 0x26E33 : (version_D2Common == V110 ? 0x4E689 : (version_D2Common == V109d ? 0x0000 : 0x0000)))))))));
                            ...
                            version_D2Game == V113c ? 0x0000 : (
                                version_D2Game == V112 ? 0x0000 : (
                                    version_D2Game == V111b ? 0x0000 : (
                                        version_D2Game == V111 ? 0x0000 : (version_D2Game == V110 ? 0x0000 : (version_D2Game == V109d ? 0x7D676 : 0x7D176)))))))));
            ...
            mem_seek(
                offset_D2Client + (
                    version_D2Client == V114d ? 0x0000 : (
                        version_D2Client == V113d ? 0x0000 : (
                            version_D2Client == V113c ? 0x0000 : (
                                version_D2Client == V112 ? 0x0000 : (
                                    version_D2Client == V111b ? 0x0000 : (
                                        version_D2Client == V111 ? 0x0000 : (version_D2Client == V110 ? 0x0000 : (version_D2Client == V109d ? 0x8E44A : 0x8F0CA)))))))));
                    ...
                    version_D2Client == V114d ? 0x0000 : (
                        version_D2Client == V113d ? 0x0000 : (
                            version_D2Client == V113c ? 0x0000 : (
                                version_D2Client == V112 ? 0x0000 : (
                                    version_D2Client == V111b ? 0x0000 : (
                                        version_D2Client == V111 ? 0x0000 : (version_D2Client == V110 ? 0x0000 : (version_D2Client == V109d ? 0x8E4BC : 0x8F13C)))))))));
            memt_byte(0x74, 0x90);//MOV EAX,EDI
